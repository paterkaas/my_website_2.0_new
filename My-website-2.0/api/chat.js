...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Everything here is now in English.
    const systemInstruction = `
      ...
      - Recreatiepark Terspegelt: https://www.booking.com/hotel/nl/recreatiepark-terspegelt (REPLACE THIS WITH YOUR LINK)
      - Camping de Paal: https://www.booking.com/camping-de-paal (REPLACE THIS WITH YOUR LINK)
      - Efteling Hotel: https://www.booking.com/hotel/nl/efteling (REPLACE THIS WITH YOUR LINK)
